...
public class EstudianteDAO {
    ...
    public List<Estudiante> listarEstudiantes(){
        ...
        // Crear algunos objetos que son necesarios para comunicar con la base de datos
        PreparedStatement ps; // Envia la sentencia a la base de datos de forma segura
        ResultSet rs; //Obtenemos y muestra el resultado de la base de datos
    ...
    public boolean buscarEstudiantePorId(Estudiante estudiante){
        ...
        try{
            ...
            if(rs.next()){
                ...
                estudiante.setTelefono(rs.getString("telefono"));
                estudiante.setEmail(rs.getString("email"));
                return true; // Si encuentro un registro
            }// fin if
        } catch (Exception e){
