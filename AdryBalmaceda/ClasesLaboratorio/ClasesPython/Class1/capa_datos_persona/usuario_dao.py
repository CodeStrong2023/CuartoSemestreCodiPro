...
class UsuarioDAO:
    ...
    def seleccionar(cls):
        with CursorDelPool() as cursor:
            log.debug('Seleecionando usuarios')
...
if __name__ == '__main__':
    ...
    #
    # actualizar usuario
    # usuario = Usuario(id_usuario=1, username='carlos', password='369')
    # usuario_actulizado = UsuarioDAO.actualizar(usuario)
    # log.debug(f'Usuario actulizado: {usuario_actulizado}')
    #
    # Insertar usuario
    # usuario = Usuario(username='ariel', password='321')
