...
mercadopago.configure({
    access_token: "",  // Asegúrate de reemplazar con tu token de acceso
});

app.use(express.urlencoded({ extended: false }));
app.use(express.json());

app.use(express.static(path.join(__dirname, "../client"))); // La ruta sería: ../../client/html-js
app.use(cors());

app.get("/", function (req, res) {
    res.sendFile(path.resolve(__dirname, "..", "client", "index.html")); // Envía el archivo index.html como respuesta
});
